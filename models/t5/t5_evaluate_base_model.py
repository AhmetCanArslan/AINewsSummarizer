...
MODEL_ID = "Turkish-NLP/t5-efficient-small-MLSUM-TR-fine-tuned"
DATA_CSV_PATH = "../../data/processed/cleaned_dataset.csv"
TEXT_COL = "cleaned_article"     
SUMMARY_COL = "cleaned_summary"   
OUTPUT_FILE = "t5_evaluate_output.csv"

if torch.backends.mps.is_available():
    device = "mps"
    print("Using device: Apple M4/MPS (GPU)") # Test for apple silicon cpu
elif torch.cuda.is_available():
    device = 0
    print("Using device: NVIDIA CUDA (GPU)")
else:
    device = "cpu"
